...
public class RepositorioPrestamoPersistente implements RepositorioPrestamo {
    ...
    @Override
    public Boolean prestrar(String isbn, String nombreUsuario, Date fechaPrestamo, Date fechaEntrega) {
        try {
            PrestamoEntity prestamo = obtenerEntidad(isbn);
            prestamo.setNombreUsuario(nombreUsuario);
            prestamo.setFechaSolicitud(fechaPrestamo);
            prestamo.setFechaEntregaMaxima(fechaEntrega);
    ...
    public PrestamoEntity obtenerEntidad(String isbn){
        PrestamoEntity prestamoEntity = obtenerPrestamoEntityPorIsbn(isbn);
